...
contract StableCoinStaking_version1 is Initializable {
    IERC20 public stakedToken;         // Staked token is USDC stable coin
    IERC20 public rewardToken;         // Reward token is Meta Token
    address owner;
